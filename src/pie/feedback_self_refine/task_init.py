...
from pie.feedback_self_refine.self_refine_feedback import FEEDBACK_INIT_Q
...
class PieSRFInit(Prompt):
    def __init__(self, engine: str, temperature: float, max_tokens: int = 300) -> None:
        ...
        self.setup_prompt_from_examples_file("./src/pie/feedback_self_refine/data/init.txt")
